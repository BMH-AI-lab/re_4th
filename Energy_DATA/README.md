...
1. 태양광 에너지
    + 태양광 에너지란?
        + 태양에서 오는 빛 에너지를 이용하여 전기를 생산함<br>
...
3. 해상 풍력 에너지 
    + 해상 풍력 에너지란? 
        + 바다나 호수와 같은 지역에 풍차를 설치한 후 그곳에서 부는 바람을 이용해 터빈을 돌려 전기 에너지를 얻는 발전 방식<br>
    + 국내 해상 풍력 에너지 이용현황 
...
4. 신재생 에너지 관련 인공지능 분야 
    ...
    + 신재생 에너지 인공지능 활용 사례 2
        ...
        <img width="694" height="490" alt="Image" src="https://github.com/user-attachments/assets/45934cde-99c4-492b-a9b3-abf6ecdd0f24" /><br>


5. 신재생 에너지 관련 지원동기 <br>
저는 기후 변화와 환경 문제를 해결하기 위해 신재생에너지 산업이 반드시 성장해야 한다고 생각합니다. 특히 안정적인 발전량 확보와 효율적인 전력망 운영은 산업 전반의 지속 가능성을 좌우하는 핵심 과제입니다. 저는 연구와 학업을 통해 인공지능과 데이터 분석 기술이 이러한 과제를 해결하는 데 중요한 역할을 할 수 있음을 경험했습니다. 이를 계기로 기술을 실제 에너지 산업에 접목해, 미래 사회에 기여할 수 있는 길을 찾고자 지원하게 되었습니다. 신재생에너지가 단순한 대체 에너지를 넘어, 국가와 사회 발전을 이끄는 중심축이 될 수 있도록 함께 성장하고 싶습니다.